...
public class MatchplayBackfiller : System.IDisposable
{
    ...
    public void AddPlayerToMatch(UserData userData)
    {
        ...
        Player matchmakerPlayer = new Player(userData.UserID, userData.UserGamePreferences);
    ...
    private async void BackfillLoop()
    {
        while (IsBackfilling)
        {
            ...
            await UniTask.Delay(TicketCheckMs);
        }
    }
